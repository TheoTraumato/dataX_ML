...
# Train model:
logreg_basis = logreg.fit(x_train, y_train)
...
print("ROC for basis model: ", plot_roc_curve(logreg_basis, x_test, y_test))
...
# GridSearch
logreg = GridSearchCV(logreg, parameters_logreg, scoring='roc_auc', cv=10)
...
print("ROC for logreg: ", plot_roc_curve(clf_logreg, x_test, y_test))
